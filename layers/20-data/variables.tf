...
variable "msk_tls_client_authority_arns" {
  description = "ACM Private CA ARNs enabling MSK mutual-TLS client-certificate auth (port 9094). Empty keeps SASL/IAM as the only client auth mechanism."
  type        = list(string)
  default     = []
}
